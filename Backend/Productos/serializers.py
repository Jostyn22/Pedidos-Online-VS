...
class ProductoSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if producto_existente:
            ...
            producto_existente.precio_costo = validated_data.get(
                "precio_costo", producto_existente.precio_costo
            )
            producto_existente.porcentaje_ganancia = validated_data.get(
                "porcentaje_ganancia", producto_existente.porcentaje_ganancia
            )
            producto_existente.save()  # recalcula precio y precio_final
    ...
    def update(self, instance, validated_data):
        ...
        if "precio_costo" in validated_data or "porcentaje_ganancia" in validated_data:
            ...
            porcentaje_ganancia = validated_data.get(
                "porcentaje_ganancia", instance.porcentaje_ganancia
            )
            validated_data["precio"] = precio_costo * (1 + porcentaje_ganancia / 100)
